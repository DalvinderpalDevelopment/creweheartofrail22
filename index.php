...
<html>
  <head>
    ...
    <meta
      name="description"
      content="Landing page for Crewe - Heart of Rail campaign"
    />
    <meta name="viewport" content="width=device-width, initial-scale=1" />

    <!-- Add Bootstrap CSS to site -->
    <link
      rel="stylesheet"
    ...
    <!-- Add JS File for site -->
    <script type="text/javascript" src="./assets/js/base.js"></script>

    <!-- Add LightSlider CSS File for site -->
    <link
      rel="stylesheet"
      href="./assets/lib/lightslider/css/lightslider.css"
    />

    <!-- Add LightSlider JS File for site -->
    <script
      type="text/javascript"
      src="./assets/lib/lightslider/js/lightslider.js"
    ></script>

    <!-- Add Pushbar JS CSS CDN for site -->
    <link rel="stylesheet" href="./assets/lib/pushbar/css/pushbar.min.css" />

    <!-- Add Pushbar JS File for site -->
    <script
      type="text/javascript"
      src="./assets/lib/pushbar/js/pushbar.min.js"
    ></script>
  </head>
  <body>
      ...
      <div class="content">
        ...
        <div class="logos">
          <img
            ...
            alt="Great British Railways Transiiton Team Logo"
          />
          <img
            class="w-100 pb-3"
            src="./assets/images/logo-1.png"
            alt="Cheshire East Council Logo"
          />
        </div>
      </div>
    </div>
    ...
    <header>
      <div class="main-header container-fluid position-relative">
        <div class="logo-section row">
          ...
          <div
            class="d-flex justify-content-center justify-content-md-end align-items-center col-12 col-md-6 pb-3 pb-md-0"
          >
            <div class="mobile">
            ...
            <div class="button py-4 px-5">
              <a
                href="#form-section"
                class="pink-button text-decoration-none mt-0"
                >Back Crewe's Bid</a
              >
            </div>
          </div>
      ...
      <div class="sticky-header container-fluid position-fixed top-0">
        <div class="logo-section row">
          <div class="col-12 col-md-6">
            <div
              class="logo d-flex justify-content-between align-items-center py-4 px-5"
            >
              <img src="./assets/images/site-logo.svg" alt="Crewe Site Logo" />
              <img
                src="./assets/images/logo-10.png"
          ...
          <div
            class="d-flex justify-content-end align-items-center col-12 col-md-6"
          >
            <div class="button py-4 px-5">
              <a
                href="#form-section"
    ...
    <section class="hero-section">
      <div class="container-fluid">
        <div class="row">
          <div
            class="text-section d-flex justify-content-center align-items-center col-12 col-md-6 p-5"
          >
            <div class="text p-5">
              <h1>Back Crewe’s bid</h1><h1>to be the home of <h1>Great British</h1><h1>Railways</h1>
            </div>
          </div>
          <div
            class="image-section d-flex justify-content-center align-items-center col-12 col-md-6 px-0"
          >
            <div class="image">
              <img
                class="w-100 img-fluid"
                src="./assets/images/hero.jpg"
                alt="Crewe station hero image"
              />
            </div>
          </div>
        </div>
    ...
    <section class="heart-rail-section">
      <div class="container-fluid">
        <div class="row">
          <div
            class="image-section d-flex justify-content-center align-items-center col-12 col-md-6 p-5"
          >
            <div class="image expandable mb-5">
              <img
                class="img-fluid"
                src="./assets/images/crewe-arial-sq.jpg"
                alt="Crewe areial view image"
              />
            </div>
          </div>
          <div
    ...
    <section class="opportunity-section">
      <div class="container-fluid">
        <div class="row">
          <div
            class="text-section d-flex justify-content-center align-items-center col-12 col-lg-6 p-4"
          >
          ...
          <div class="image-section col-12 col-lg-6 px-0">
            <div class="image">
              <img
                class="w-100 img-fluid"
                src="./assets/images/hs2-render.jpg"
                alt="HS2 train image"
              />
            </div>
          </div>
    ...
    <section class="supporters-advocates-section">
      <div class="container py-5">
            ...
            <ul id="carousel-advocates">
              <li>
                <div class="item image expandable">
                  <img
                    src="./assets/images/pete-waterman.jpg"
                    class="d-block w-100"
                    alt="Pete Waterman Image"
                  />
              ...
              <li>
                <div class="item image expandable">
                  <img
                    src="./assets/images/peter-graham.jpg"
                    class="d-block w-100"
                    alt="Peter Graham Image"
                  />
                  <div class="carousel-info d-flex justify-content-center py-5">
                    <div class="text-center">
                      <h4>Peter Graham</h4>
              ...
              <li>
                <div class="item image expandable">
                  <img
                    src="./assets/images/doug-kinsman.jpg"
                    class="d-block w-100"
                    alt="Doug Kinsman Image"
                  />
                  <div class="carousel-info d-flex justify-content-center py-5">
                    <div class="text-center">
                      <h4>Doug Kinsman</h4>
              ...
              <li>
                <div class="item image expandable">
                  <img
                    src="./assets/images/dr-keiran-mullan.jpg"
                    class="d-block w-100"
                    alt="Dr Kieran Mullan Image"
                  />
                  <div class="carousel-info d-flex justify-content-center py-5">
                    <div class="text-center">
        ...
        >
          <div
            class="icons d-flex justify-content-center col-12 col-md-6 col-lg-2 py-3 py-lg-0"
          >
            <img
              src="./assets/images/logo-1.png"
              alt="Cheshire east council logo"
          ...
          >
            <img
              ...
              alt="Cheshire and Warrington partnership logo"
            />
          </div>
          <div
            class="icons d-flex justify-content-center col-12 col-md-6 col-lg-2 py-3 py-lg-0"
    ...
    <section class="supporter-section container">
      <div class="row mx-0 py-5">
        <div
          class="d-flex justify-content-start align-items-center col-12 col-md-6"
        >
        ...
        <div class="video d-flex align-items-center col-12 col-md-6 text-end">
          <video class="w-100" poster="./assets//images/video-still.jpg">
      ...
      <div class="container">
        ...
        <div class="content row justify-content-between mx-0 pt-4">
          ...
          <div class="article col-md-4 image expandable pb-4 pb-md-0">
            <img
              class="w-100 img-fluid"
              src="./assets/images/avanti-train.jpg"
              alt="Avanti train image"
            />
            <div class="article-info pt-4">
              <h4>Article title to go here</h4>
              <p><?php echo date('d.m.y'); ?></p>
    ...
    <section id="form-section" class="form-section">
      <div class="container">
        <div class="row mx-0">
          ...
          <div
            class="form-component d-flex justify-content-end col-12 col-md-6"
          >
            <form id="crewe-form" action="" method="POST">
              ...
              <div class="form-element">
                ...
                />
                <label for="updates"
                  >Tick to confirm you’re happy to receive updates</label
                >
              </div>
              <div class="form-element d-flex justify-content-end">
                <input
                  class="submit pink-button"
                  type="submit"
                  name="submit"
                  value="Send Message"
                />
    ...
    <footer>
      <div class="container">
        ...
        <div class="footer-links row py-3 pt-0 pt-md-3">
          <div
            class="social-icons col-12 col-md-2 text-center text-md-start py-3 py-md-0"
          >
          ...
          <div
            class="copyright col-12 col-md-2 text-center text-md-end py-3 py-md-0"
          >
